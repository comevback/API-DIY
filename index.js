...
app.get("/filter", (req, res) => {
  ...
  const jokes_type = jokes.filter(joke => joke.jokeType === filter);
  console.log(jokes_type);
  res.send(jokes_type);
})
...
app.put("/jokes/:id", (req, res) => {
  const jokeID = parseInt(req.params.id);
  //console.log(jokeID);
  const putJoke = req.body;
  //console.log(putJoke);
  jokes[jokeID - 1].jokeText = putJoke.jokeText;
  jokes[jokeID - 1].jokeType = putJoke.jokeType;
  //console.log(jokes[jokeID - 1]);
  res.send(jokes[jokeID - 1]);
})
...
app.patch("/jokes/:id", (req, res) => {
  ...
  const putJoke = req.body;
  //console.log(putJoke);
  if(putJoke.jokeText){jokes[jokeID - 1].jokeText = putJoke.jokeText;}
  if(putJoke.jokeType){jokes[jokeID - 1].jokeType = putJoke.jokeType;}
  //console.log(jokes[jokeID - 1]);
  res.send(jokes[jokeID - 1]);
})
